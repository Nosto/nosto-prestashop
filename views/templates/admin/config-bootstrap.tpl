                                        ...
                                        <div class="content-panel">
                                            ...
                                            <div class="row">
                                                <div class="col-sxs-12 col-sm-6">
                                                    ...
                                                    <img src="/public/platform/img/install-feature-facebook.jpg" alt="">
                                                </div>
                                                <div class="col-sxs-12 col-sm-6">
                                                    <h6>{l s='Product Recommendations' mod='nostotagging'}</h6>
                                                    <!-- extras.platforms.install.productRecommendations -->
                                                    <img src="/public/platform/img/install-feature-recommendations.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sxs-12 col-sm-6">
                                                    ...
                                                    <img src="/public/platform/img/install-feature-popups.jpg" alt="">
                                                </div>
                                                <div class="col-sxs-12 col-sm-6">
