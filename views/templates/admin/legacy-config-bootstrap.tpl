						...
						<form class="nostotagging" id="nosto_form_id" role="form" action="{$nostotagging_form_action|escape:'htmlall':'UTF-8'}" method="post" enctype="multipart/form-data" novalidate="">
								...
								<div class="panel panel-default">
										...
										<div class="panel-body text-center">
												{if $nostotagging_account_authorized}
														<div id="nostotagging_installed" class="nostotagging_settings" style="{if !empty($iframe_url)}display: none;{/if}">
                            ...
                            in to your store admin and when you update the exchange rates.'
																										...
																										<p class="help-block">
																										{l
																												s='You can set up the cron job for updating the exchange rates by adding the
