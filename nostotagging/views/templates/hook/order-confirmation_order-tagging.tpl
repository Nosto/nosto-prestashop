{if isset($nosto_order) && is_array($nosto_order)}
	<div class="nosto_purchase_order" style="display:none">
		...
		<div class="buyer">
			<span class="first_name">{$nosto_order.customer.firstname|escape:'htmlall':'UTF-8'}</span>
			<span class="last_name">{$nosto_order.customer.lastname|escape:'htmlall':'UTF-8'}</span>
