<div class="row">
    <div class="col-lg-2">
        ...
        <ul class="nav nav-pills nav-stacked" role="tablist">
            <li class="active"><a href="#general-settings" role="tab" data-toggle="tab">{l s='General Settings' mod='nostotagging'}</a></li>
            {if !empty($manage_slots_iframe_url)}
                <li><a href="#manage-slots" role="tab" data-toggle="tab">{l s='Manage slots' mod='nostotagging'}</a></li>
            {/if}
            {if !empty($look_and_feel_iframe_url)}
                <li><a href="#look-feel" role="tab" data-toggle="tab">{l s='Look & feel' mod='nostotagging'}</a></li>
            {/if}
        </ul>
    </div>
    <div class="col-lg-10">
        ...
        <div class="tab-content">
            ...
            {if !empty($manage_slots_iframe_url)}
                <div class="tab-pane" id="manage-slots">
                    <iframe id="nosto_recs" frameborder="0" style="width:100%; height:1250px;" src="{$manage_slots_iframe_url}"></iframe>
                </div>
            {/if}
            {if !empty($look_and_feel_iframe_url)}
                <div class="tab-pane" id="look-feel">
                    <iframe id="nosto_recs" frameborder="0" style="width:100%; height:1250px;" src="{$look_and_feel_iframe_url}"></iframe>
                </div>
            {/if}
        </div>
    </div>
