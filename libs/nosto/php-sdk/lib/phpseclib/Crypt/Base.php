 ...
 *
 *  - The new \phpseclib\Crypt\* cipher class should extend phpseclib_Crypt_Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend phpseclib_Crypt_Base
 ...
 * @author  Hans-Juergen Petrich <petrich@tronic-media.com>
 */
abstract class phpseclib_Crypt_Base
{
    /**#@+
     * @access public
     * @see phpseclib_Crypt_Base::encrypt()
     * @see phpseclib_Crypt_Base::decrypt()
     */
    /**
     ...
     *
     * @see phpseclib_Crypt_Base::_hashInlineCryptFunction()
     * @var Boolean
     * @access private
     */
    ...
    /**#@+
     * @access private
     * @see phpseclib_Crypt_Base::__construct()
     */
    /**
     ...
     * The Key
     *
     * @see phpseclib_Crypt_Base::setKey()
     * @var String
     * @access private
     */
     ...
     *
     * @see phpseclib_Crypt_Base::setIV()
     * @var String
     * @access private
     */
    var $iv;
     ...
     *
     * @see phpseclib_Crypt_Base::enableContinuousBuffer()
     * @see phpseclib_Crypt_Base::_clearBuffers()
     * @var String
     * @access private
     */
    var $encryptIV;
     ...
     * @see phpseclib_Crypt_Base::encrypt()
     * @see phpseclib_Crypt_Base::decrypt()
     * @see phpseclib_Crypt_Base::_setupMcrypt()
     * @var Resource
     * @access private
     */
    var $ecb;
     ...
     * Padding status
     *
     * @see phpseclib_Crypt_Base::enablePadding()
     * @var Boolean
     * @access private
     */
    var $padding = true;
     ...
     *
     * @see phpseclib_Crypt_Base::_setEngine()
     * @see phpseclib_Crypt_Base::encrypt()
     * @see phpseclib_Crypt_Base::decrypt()
     * @var Integer
     * @access private
     ...
     *
     * @see phpseclib_Crypt_Base::_setEngine()
     * @see phpseclib_Crypt_Base::setPreferredEngine()
     * @var Integer
     * @access private
     */
    var $preferredEngine;
     ...
     *
     * @see phpseclib_Crypt_Base::setPassword()
     * @var Integer
     * @access private
     */
     ...
     * @see phpseclib_Crypt_Base::encrypt()
     * @see phpseclib_Crypt_Base::decrypt()
     * @see phpseclib_Crypt_Base::_setupInlineCrypt()
     * @see phpseclib_Crypt_Base::$use_inline_crypt
     * @var Callback
     * @access private
     */
    var $inline_crypt;
     ...
     * @see phpseclib_Crypt_Base::encrypt()
     * @see phpseclib_Crypt_Base::decrypt()
     * @see phpseclib_Crypt_Base::inline_crypt
     * @var mixed
     * @access private
     */
     ...
     *
     * @see phpseclib_Crypt_Base::_openssl_ctr_process()
     * @var Boolean
     * @access private
     */
     ...
     *
     * @see phpseclib_Crypt_Base::isValidEngine()
     * @var mixed
     * @access private
     */
    var $openssl_options;
    ...
    function setPassword($password, $method = 'pbkdf2')
    {
        ...
        switch ($method) {
            default: // 'pbkdf2' or 'pbkdf1'
                ...
                switch (true) {
                    case $method == 'pbkdf1':
                        $hashObj = new phpseclib_Crypt_Hash();
     ...
     *
     * @see phpseclib_Crypt_Base::disablePadding()
     * @access public
     */
     ...
     *
     * @see phpseclib_Crypt_Base::disableContinuousBuffer()
     * @access public
     * @internal Could, but not must, extend by the child Crypt_* class
     */
     ...
     *
     * @see phpseclib_Crypt_Base::Crypt_Base()
     ...
     *
     * - phpseclib_Crypt_Base::ENGINE_OPENSSL  [very fast]
     *
     * - phpseclib_Crypt_Base::ENGINE_MCRYPT   [fast]
     *
     * - phpseclib_Crypt_Base::ENGINE_INTERNAL [slow]
     *
     ...
     *
     * @see phpseclib_Crypt_Base::_setup()
     * @access private
     */
     ...
     *
     * @see phpseclib_Crypt_Base::_unpad()
     * @param String $text
     * @access private
     * @return String
     */
     ...
     *
     * @see phpseclib_Crypt_Base::_setup()
     * @see phpseclib_Crypt_Base::_createInlineCryptFunction()
     * @see phpseclib_Crypt_Base::encrypt()
     * @see phpseclib_Crypt_Base::decrypt()
     * @access private
    ...
    {
        // If, for any reason, an extending phpseclib_Crypt_Base() \phpseclib\Crypt\* class
